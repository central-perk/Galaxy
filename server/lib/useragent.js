module.exports = (function() {
	...
	var s = {
		SAMSUNG: {
			...
			"GT-S5560": [p, "Marvel"],
			"GT-S5620": [p, "Monte"],
			"GT-S7550": [p, "Blue Earth"],
			"GT-S8000": [p, "Jet"],
			"SGH-F480": [p, "Tocco"],
			"SGH-T528g": [p, "Straight Talk"],
			"GT-B3410": [p, "Star Qwerty"],
			"GT-B5310": [p, "Corby Pro"],
			"GT-B7722": [p, "Star Duos"]
		}
	};
	var e = {
		SAMSUNG: {
			...
			"GT-S5380": [p, "Wave Y"],
			"GT-S5380D": [p, "Wave Y"],
			"GT-S5750E": [p, "Wave 575"],
			"GT-S7230B": [p, "Wave 723"],
			"GT-S7230E": [p, "Wave 723"],
			"GT-S7233E": [p, "Wave 723"],
			"GT-S7250": [p, "Wave M"],
			"GT-S8500": [p, "Wave"],
			"GT-S8500C": [p, "Wave"],
			"GT-S8500R": [p, "Wave"],
	...
	var l = {
		SAMSUNG: {
			"GT-I9500": [p, "Galaxy S III"]
		}
	};
	var r = {
		CoolPadF800: ["Coolpad", "F800"],
		"HD mini T5555": [q, "HD mini"],
		"HTC HD2 T8585": [q, "HD2"],
		"HTC Touch2 T3335": [q, "Touch 2"],
		"HTC TyTN II": [q, "TyTN II"],
		"GT-B7300": [p, "Omnia Lite"],
		"GT-B7610": [p, "Omnia Pro"],
		"GT-i8000": [p, "Omnia 2"],
		"GT-I8000": [p, "Omnia 2"],
		"GT-I8000U": [p, "Omnia 2"],
		M1i: [c, "M1i Aspen"]
	...
	var o = {
		...
		LG: {
			GW910: [b, "Optimus 7"],
			"LG-E900": [b, "Optimus 7 E900"],
			"LG-E900h": [b, "Optimus 7 E900"],
			GW910: [b, "GW910"],
			"LG-C900": [b, "Optimus 7Q"],
			"LG-C900k": [b, "Quantum"]
		},
		NOKIA: {
	...
	var j = {
		...
		"Acer Iconia A500": ["Acer", "Iconia Tab A500", "tablet"],
		...
		Novo7Basic: ["Ainol", "Novo7 Basic", "tablet"],
		Novo7Advanced: ["Ainol", "Novo7 Advanced", "tablet"],
		NOVO7PALADIN: ["Ainol", "Novo7 Paladin", "tablet"],
		"Ainol Novo8 Advanced": ["Ainol", "Novo8 Advanced", "tablet"],
		...
		NookColor: ["Barnes & Noble", "NOOK Color", "tablet"],
		"NOOK BNRV200": ["Barnes & Noble", "NOOK Color", "tablet"],
		"NOOK BNTV250": ["Barnes & Noble", "NOOK Tablet", "tablet"],
		BNTV250: ["Barnes & Noble", "NOOK Tablet", "tablet"],
		...
		Z71: ["Commtiva", "Z71", "tablet"],
		D530: ["Coolpad", "D530", "tablet"],
		"Coolpad W706": ["Coolpad", "W706", "tablet"],
		W711: ["Coolpad", "W711", "tablet"],
		"5860": ["Coolpad", "5860", "tablet"],
		CoolPad8810: ["Coolpad", "8810", "tablet"],
		CoolPad8811: ["Coolpad", "8811", "tablet"],
		"ZiiLABS ZiiO10 ": ["Creative", "ZiiO 10", "tablet"],
		"CUBE K8GT_A": ["Cube", "K8GT A"],
		"CUBE K8GT H": ["Cube", "K8GT H"],
		"CUBE U8GT": ["Cube", "U8GT"],
		"CUBE U9GT 2": ["Cube", "U9GT 2"],
		"U9GT S": ["Cube", "U9GT S"],
		"Dell Streak": ["Dell", "Streak"],
		"001DL": ["Dell", "Streak"],
		"Dell Streak Pro": ["Dell", "Streak Pro"],
		"Dell Streak 7": ["Dell", "Streak 7"],
		"Dell Streak 10 Pro": ["Dell", "Streak 10 Pro"],
		"Dell V04B": ["Dell", "Streak V04B"],
		XCD35: ["Dell", "XCD35"],
		...
		"HTC Amaze 4G": [q, "Amaze 4G"],
		"HTC Aria A6380": [q, "Aria"],
		"HTC ChaCha A810e": [q, "ChaCha"],
		"HTC click": [q, "Click"],
		"HTC Desire": [q, "Desire"],
		"HTC Desire A8181": [q, "Desire"],
		"HTC Desire A8183": [q, "Desire"],
		"HTC Desire Beats A8181": [q, "Desire"],
		"HTC DesireHD": [q, "Desire HD"],
		"HTC DesireHD A9191": [q, "Desire HD"],
		"HTC Desire HD A9191": [q, "Desire HD"],
		"HTC A9191": [q, "Desire HD"],
		"HTC A9192": [q, "Desire HD"],
		"HTC Desire HD": [q, "Desire HD"],
		"HTC Desire HD with Beats Audio": [q, "Desire HD"],
		"HTC Desire S": [q, "Desire S"],
		"HTC DesireS": [q, "Desire S"],
		"HTC DesireS S510e": [q, "Desire S"],
		"HTC DesireS S510b": [q, "Desire S"],
		"HTC Desire Z": [q, "Desire Z"],
		"HTC DesireZ A7272": [q, "Desire Z"],
		"HTC Dream": [q, "Dream"],
		"HTC S710d": [q, "Droid Incredible 2"],
		"HTC EVA UL": [q, "Eva"],
		"HTC X515m": [q, "EVO 3D"],
		"HTC Evo 3D": [q, "EVO 3D"],
		"HTC EVO 3D GSM": [q, "EVO 3D"],
		"HTC EVO 3D X515m": [q, "EVO 3D"],
		"HTC EVO3D X515a": [q, "EVO 3D"],
		"HTC EVO3D X515m": [q, "EVO 3D"],
		"HTC X515E": [q, "EVO 4G+"],
		"HTC Explorer": [q, "Explorer"],
		"HTC Explorer A310e": [q, "Explorer"],
		"HTC Flyer P510e": [q, "Flyer"],
		"HTC Flyer P512": [q, "Flyer"],
		"HTC Glacier": [q, "Glacier"],
		"HTC Gratia A6380": [q, "Gratia"],
		"HTC HD": [q, "HD"],
		"HTC HD2": [q, "HD2"],
		"HTC HD2 T8585": [q, "HD2"],
		"HTC Hero": [q, "Hero"],
		"HTC HERO200": [q, "Hero 200"],
		"HTC PH39100": [q, "Holiday"],
		"HTC Holiday": [q, "Holiday"],
		"HTC Incredible S": [q, "Incredible S"],
		"HTC IncredibleS S710e": [q, "Incredible S"],
		"HTC Legend": [q, "Legend"],
		"HTC Liberty A6380": [q, "Liberty"],
		"HTC Magic": [q, "Magic"],
		"HTC Panache": [q, "Panache"],
		"HTC Pyramid": [q, "Pyramid"],
		"HTC X710a": [q, "Raider 4G"],
		"HTC Raider X710e": [q, "Raider 4G"],
		"HTC Raider 4G X710e": [q, "Raider 4G"],
		"HTC Rhyme S510b": [q, "Rhyme"],
		"HTC Runnymede": [q, "Runnymede"],
		"HTC Salsa C510e": [q, "Salsa"],
		"HTC C510e": [q, "Salsa"],
		"HTC Sapphire": [q, "Sapphire"],
		"HTC Z710e": [q, "Sensation"],
		"HTC Z710t": [q, "Sensation"],
		"HTC Sensation": [q, "Sensation"],
		"HTC Sensation Z710a": [q, "Sensation"],
		"HTC Sensation Z710e": [q, "Sensation"],
		"HTC Sensation Z710E": [q, "Sensation"],
		"HTC Sensation Z715e": [q, "Sensation XE"],
		"HTC Sensation 4G": [q, "Sensation 4G"],
		"HTC Z715e": [q, "Sensation XE"],
		"HTC Sensation Z710e with Beats Audio": [q, "Sensation"],
		"HTC SensationXE Beats Z715e": [q, "Sensation XE"],
		"HTC Sensation XE with Beats Audio": [q, "Sensation XE"],
		"HTC Sensation XE with Beats Audio Z715e": [q, "Sensation XE"],
		"HTC SensationXL Beats X315e": [q, "Sensation XL"],
		"HTC Sensation XL with Beats Audio X315e": [q, "Sensation XL"],
		"HTC Tattoo": [q, "Tattoo"],
		"HTC T7373": [q, "Touch Pro II"],
		"HTC ThunderBolt": [q, "ThunderBolt"],
		"HTC Vision": [q, "Vision"],
		"HTC Vivo": [q, "Vivo"],
		"HTC Wildfire": [q, "Wildfire"],
		"HTC Wildfire A3333": [q, "Wildfire"],
		"HTC WildfireS": [q, "Wildfire S"],
		"HTC Wildfire S": [q, "Wildfire S"],
		"HTC Wildfire S A510e": [q, "Wildfire S"],
		"HTC WildfireS A510e": [q, "Wildfire S"],
		"HTC A510e": [q, "Wildfire S"],
		"HTC A510a": [q, "Wildfire S"],
		HTCX06HT: [q, "Desire"],
		Click: [q, "Click"],
		"Desire A8181": [q, "Desire"],
		"Desire HD": [q, "Desire HD"],
		"Desire S": [q, "Desire S"],
		Dream: [q, "Dream"],
		"EVO 4G": [q, "EVO 4G"],
		Hero: [q, "Hero"],
		HERO200: [q, "Hero 200"],
		"Incredible S": [q, "Incredible S"],
		"Inspire 4G": [q, "Inspire 4G"],
		Legend: [q, "Legend"],
		Liberty: [q, "Liberty"],
		NexusHD2: [q, "HD2"],
		"Docomo HT-03A": [q, "Magic"],
		"MIUI.us Sensation 4G": [q, "Sensation 4G"],
		"SiRF Dream": [q, "Dream"],
		Sensation: [q, "Sensation"],
		"Sensation Z710e": [q, "Sensation"],
		"Sensation 4G": [q, "Sensation 4G"],
		"SensationXE Beats Z715e": [q, "Sensation XE"],
		"SensationXL Beats X315e": [q, "Sensation XL"],
		"Sprint APX515CKT": [q, "EVO 3D"],
		"Sprint APA9292KT": [q, "EVO 4G"],
		"Sprint APA7373KT": [q, "EVO Shift 4G"],
		"Sprint APC715CKT": [q, "EVO Design 4G"],
		A6277: [q, "Hero"],
		X06HT: [q, "Desire"],
		"001HT": [q, "Desire HD"],
		ADR6300: [q, "Droid Incredible"],
		ADR6350: [q, "Droid Incredible 2"],
		ADR6400L: [q, "Thunderbolt 4G"],
		"ADR6400L 4G": [q, "Thunderbolt 4G"],
		ADR6425LVW: [q, "Vigor"],
		"ADR6425LVW 4G": [q, "Rezound 4G"],
		PG06100: [q, "EVO Shift 4G"],
		PG41200: [q, "EVO View 4G"],
		PG86100: [q, "EVO 3D"],
		PG8610000: [q, "EVO 3D"],
		PC36100: [q, "EVO 4G"],
		ISW11HT: [q, "EVO WiMax"],
		...
		U8500: [h, "IDEOS X2"],
		U8510: [h, "IDEOS X3"],
		"Huawei Ideos X5 1.12.9(ret4rt)": [h, "IDEOS X5"],
		"IDEOS X5": [h, "IDEOS X5"],
		"IDEOS S7": [h, "IDEOS S7"],
		"IDEOS S7 Slim": [h, "IDEOS S7 Slim"],
		U8650: [h, "Sonic"],
		"Kyivstar Aqua": [h, "Sonic"],
		"Lucky Ultra Sonic U8650": [h, "Sonic"],
		U8660: [h, "U8660"],
		u8800: [h, "IDEOS X5"],
		U8800: [h, "IDEOS X5"],
		U8800Pro: [h, "U8800 Pro"],
		u8800pro: [h, "U8800 Pro"],
		"U8800 Pro": [h, "U8800 Pro"],
		U8850: [h, "Vision"],
		u8860: [h, "Honor"],
		U8860: [h, "Honor"],
		U9000: [h, "Ascend X"],
		"HUAWEI-U9000": [h, "Ascend X"],
		"HUAWEI MediaPad": [h, "MediaPad", "tablet"],
		"HUAWEI SONIC": [h, "Sonic"],
		"HUAWEI T8300": [h, "T8300"],
		"Huawei C8500": [h, "C8500"],
		...
		W606: ["K-Touch", "W606"],
		W700: ["K-Touch", "W700"],
		"ThinkPad Tablet": [d, "ThinkPad Tablet", "tablet"],
		K1: [d, "IdeaPad K1", "tablet"],
		"A1 07": [d, "LePad", "tablet"],
		"lepad 001n": [d, "LePad", "tablet"],
		"3GC101": [d, "LePhone 3GC101"],
		"3GW100": [d, "LePhone 3GW100"],
		"Lenovo 3GW100": [d, "LePhone 3GW100"],
		"3GW101": [d, "LePhone 3GW101"],
		"Lenovo 3GW101": [d, "LePhone 3GW101"],
		"Lenovo S1-37AH0": [d, "LePhone S1-37AH0"],
		"Lenovo Lenovo S1-37AH0": [d, "LePhone S1-37AH0"],
		"Lenovo A500": [d, "LePhone A500"],
		"Lenovo P70": [d, "LePhone P70"],
		A30t: [d, "A30t"],
		"Lenovo-A60": [d, "A60"],
		"Lenovo A60": [d, "A60"],
		"Lenovo A68e": [d, "A68e"],
		"S2005A-H": [d, "S2005A-H"],
		"LG-C800G": [b, "Eclypse"],
		"LG-E510": [b, "Optimus Hub"],
		"LG-E720": [b, "Optimus Chic"],
		"LG-E730": [b, "Optimus Sol"],
		"LG-F120L": [b, "LG-F120L"],
		"LG-GT540": [b, "Optimus"],
		"LG GT540 Swift": [b, "Optimus"],
		"LG-GW620": [b, "GW620"],
		"LG-LS855": [b, "Marquee"],
		"LG-LU3000": [b, "Optimus Mach"],
		"LG-LU5400": [b, "LU5400"],
		"LG-LU6200": [b, "Optimus Q2"],
		"LG-LU6500": [b, "Optimus Note"],
		"LG-MS910": [b, "Esteem"],
		"LG-MS690": [b, "Optimus M"],
		"LG P350": [b, "Optimus Me"],
		"LG-P350": [b, "Optimus Me"],
		"LG-P350f": [b, "Optimus Me"],
		"LG-P350g": [b, "Optimus Me"],
		"LG-P500": [b, "Optimus One"],
		"LG-P500h": [b, "Optimus One"],
		"LG-P500h-parrot": [b, "Optimus One"],
		"LG-P503": [b, "Optimus One"],
		"LG-P505R": [b, "Phoenix"],
		"LG-P509": [b, "Optimus T"],
		"LG-P698f": [b, "Optimus Net"],
		"LG-P700": [b, "Optimus P700"],
		"LG-P720": [b, "Optimus Chic"],
		"LG-P860": [b, "P860"],
		"LG-P880": [b, "X3"],
		"LG-P920": [b, "Optimus 3D"],
		"LG-P925": [b, "Thrill"],
		"LG-P930": [b, "Nitro HD"],
		"LG-P940": [b, "PRADA 3.0"],
		"LG-P970": [b, "Optimus Black"],
		"LG-P970h": [b, "Optimus Black"],
		"LG-P990": [b, "Optimus 2X Speed"],
		"LG-P993": [b, "Optimus 2X"],
		"LG-SU640": [b, "Optimus LTE"],
		"LG-SU660": [b, "Optimus 2X"],
		"LG-SU760": [b, "Optimus 3D"],
		"LG-V900": [b, "Optimus Pad", "tablet"],
		"LG-V905R": [b, "Optimus G-Slate", "tablet"],
		"LG-V909": [b, "Optimus G-Slate", "tablet"],
		"LG-VM670": [b, "Optimus V"],
		"LG-VM701": [b, "Optimus Slider"],
		"LG-VS700": [b, "Enlighten"],
		GT540: [b, "Optimus GT540"],
		LS670: [b, "Optimus S"],
		P940: [b, "PRADA 3.0"],
		VM670: [b, "Optimus V"],
		"VS910 4G": [b, "Revolution 4G"],
		"L-01D": [b, "Optimus LTE"],
		"L-02D": [b, "PRADA phone"],
		"L-06C": [b, "Optimus Pad", "tablet"],
		"L-07C": [b, "Optimus Bright"],
		"LG Optimus One P500": [b, "Optimus One"],
		"LG Optimus 2X": [b, "Optimus 2X"],
		Optimus: [b, "Optimus"],
		"Optimus Me": [b, "Optimus Me"],
		"Optimus 2X": [b, "Optimus 2X"],
		IS11LG: [b, "Optimus X"],
		...
		A853: [m, "Milestone"],
		A953: [m, "Milestone 2"],
		ET1: [m, "ET1 Enterprise Tablet", "tablet"],
		MB200: [m, "CLIQ"],
		MB300: [m, "BACKFLIP"],
		MB511: [m, "FLIPOUT"],
		MB525: [m, "DEFY"],
		...
		MT810: [m, "MOTO MT810"],
		MT870: [m, "MOTO MT870"],
		MZ505: [m, "XOOM Family Edition", "tablet"],
		MZ600: [m, "XOOM 4G LTE", "tablet"],
		MZ601: [m, "XOOM 3G", "tablet"],
		MZ602: [m, "XOOM 4G LTE", "tablet"],
		MZ603: [m, "XOOM 3G", "tablet"],
		MZ604: [m, "XOOM WiFi", "tablet"],
		MZ605: [m, "XOOM 3G", "tablet"],
		MZ606: [m, "XOOM WiFi", "tablet"],
		MZ607: [m, "XOOM 2 WiFi Media Edition", "tablet"],
		MZ609: [m, "Droid XYBOARD 8.2", "tablet"],
		MZ615: [m, "XOOM 2 WiFi", "tablet"],
		MZ617: [m, "Droid XYBOARD 10.1", "tablet"],
		"MZ617 4G": [m, "Droid XYBOARD 10.1", "tablet"],
		XT300: [m, "SPICE"],
		XT311: [m, "FIRE"],
		XT316: [m, "MOTO XT316"],
		XT502: [m, "QUENCH XT5"],
		...
		Droid: [m, "Droid"],
		DROID2: [m, "Droid 2"],
		"DROID2 GLOBAL": [m, "Droid 2"],
		DROID3: [m, "Droid 3"],
		"DROID BIONIC": [m, "Droid Bionic"],
		"DROID BIONIC 4G": [m, "Droid Bionic"],
		"DROID RAZR": [m, "Droid RAZR"],
		"DROID RAZR 4G": [m, "Droid RAZR"],
		DROIDX: [m, "Droid X"],
		"Droid X": [m, "Droid X"],
		"DROID X2": [m, "Droid X2"],
		"Milestone XT720": [m, "Milestone"],
		Milestone: [m, "Milestone"],
		"Milestone X": [m, "Milestone X"],
		Triumph: [m, "TRIUMPH"],
		XOOM: [m, "XOOM", "tablet"],
		Xoom: [m, "XOOM", "tablet"],
		ISW11M: [m, "PHOTON"],
		MOTWX435KT: [m, "TRIUMPH"],
		"MTC 955": ["MTC", "955"],
		...
		"Galaxy Nexus": [p, "Galaxy Nexus"],
		"GT-B5510": [p, "Galaxy Y Pro"],
		"GT-B7510": [p, "Galaxy Pro"],
		"GT-I5500": [p, "Galaxy 5"],
		"GT-I5500L": [p, "Galaxy 5"],
		"GT-I5503": [p, "Galaxy 5"],
		"GT-I5508": [p, "Galaxy 5"],
		"GT-I5510": [p, "Galaxy 551"],
		"GT-I5510L": [p, "Galaxy 551"],
		"GT-I5510T": [p, "Galaxy 551"],
		"GT-I5700": [p, "Galaxy Spica"],
		"GT-I5800": [p, "Galaxy Apollo"],
		"GT-I5801": [p, "Galaxy Apollo"],
		"GT-I8000": [p, "Omnia 2"],
		"GT-I8150": [p, "Galaxy W"],
		"GT-I8320": [p, "H1"],
		"GT-I9000": [p, "Galaxy S"],
		"GT-I9000B": [p, "Galaxy S"],
		"GT-I9000M": [p, "Galaxy S Vibrant"],
		"GT-I9000T": [p, "Galaxy S"],
		"GT-I9001": [p, "Galaxy S Plus"],
		"GT-I9003": [p, "Galaxy SL"],
		"GT-I9008": [p, "Galaxy S"],
		"GT-I9008L": [p, "Galaxy S"],
		"GT-I9018": [p, "Galaxy GT-I9018"],
		"GT-I9070": [p, "Galaxy S Advance"],
		"GT-I9100": [p, "Galaxy S II"],
		"GT-I9100G": [p, "Galaxy S II"],
		"GT-I9100M": [p, "Galaxy S II"],
		"GT-I9100T": [p, "Galaxy S II"],
		"GT-I9100P": [p, "Galaxy S II"],
		"GT-I9103": [p, "Galaxy R"],
		"GT-I9108": [p, "Galaxy S II"],
		"GT-I9210": [p, "Galaxy S II LTE"],
		"GT-I9220": [p, "Galaxy Note"],
		"GT-I9300": [p, "Galaxy S III"],
		"GT-I9500": [p, "Galaxy S III"],
		"GT-N7000": [p, "Galaxy Note"],
		"GT-P1000": [p, "Galaxy Tab", "tablet"],
		"GT-P1000L": [p, "Galaxy Tab", "tablet"],
		"GT-P1000M": [p, "Galaxy Tab", "tablet"],
		"GT-P1000N": [p, "Galaxy Tab", "tablet"],
		"GT-P1000T": [p, "Galaxy Tab", "tablet"],
		"GT-P1010": [p, "Galaxy Tab", "tablet"],
		"GT-P6200": [p, "Galaxy Tab 7.0 Plus", "tablet"],
		"GT-P6200L": [p, "Galaxy Tab 7.0 Plus", "tablet"],
		"GT-P6210": [p, "Galaxy Tab 7.0 Plus", "tablet"],
		"GT-P6800": [p, "Galaxy Tab 7.7", "tablet"],
		"GT-P7100": [p, "Galaxy Tab 10.1V", "tablet"],
		"GT-P7300": [p, "Galaxy Tab 8.9", "tablet"],
		"GT-P7300B": [p, "Galaxy Tab 8.9", "tablet"],
		"GT-P7310": [p, "Galaxy Tab 8.9", "tablet"],
		"GT-P7500": [p, "Galaxy Tab 10.1", "tablet"],
		"GT-P7500R": [p, "Galaxy Tab 10.1", "tablet"],
		"GT-P7500V": [p, "Galaxy Tab 10.1", "tablet"],
		"GT-P7501": [p, "Galaxy Tab 10.1N", "tablet"],
		"GT-P7510": [p, "Galaxy Tab 10.1", "tablet"],
		"GT-P7511": [p, "Galaxy Tab 10.1N", "tablet"],
		"GT-S5360": [p, "Galaxy Y"],
		"GT-S5360B": [p, "Galaxy Y"],
		"GT-S5570": [p, "Galaxy Mini"],
		"GT-S5570B": [p, "Galaxy Mini"],
		"GT-S5570L": [p, "Galaxy Mini"],
		"GT-S5578": [p, "Galaxy Mini"],
		"GT-S5660": [p, "Galaxy Gio"],
		"GT-S5660M": [p, "Galaxy Gio"],
		"GT-S5670": [p, "Galaxy Fit"],
		"GT-S5820": [p, "Galaxy Ace"],
		"GT-S5830": [p, "Galaxy Ace"],
		"GT-S5830L": [p, "Galaxy Ace"],
		"SCH-i559": [p, "Galaxy Pop"],
		"SCH-i569": [p, "Galaxy Gio"],
		"SCH-I400": [p, "Continuum"],
		"SCH-I500": [p, "Fascinate"],
		"SCH-i509": [p, "Galaxy Y"],
		"SCH-I510": [p, "Stealth V"],
		"SCH-I510 4G": [p, "Droid Charge"],
		"SCH-i579": [p, "Galaxy Ace"],
		"SCH-i809": [p, "SCH-I809"],
		"SCH-I905": [p, "Galaxy Tab 10.1", "tablet"],
		"SCH-i909": [p, "Galaxy S"],
		"SCH-I909": [p, "Galaxy S"],
		"SCH-M828C[9096483449]": [p, "Galaxy Precedent"],
		"SCH-R720": [p, "Admire"],
		"SCH-R910": [p, "Galaxy Indulge 4G"],
		"SCH-R915": [p, "Galaxy Indulge"],
		"SCH-W899": [p, "SCH-W899"],
		"SGH-I727": [p, "Galaxy S II Skyrocket"],
		"SGH-i727R": [p, "Galaxy S II"],
		"SGH-I727R": [p, "Galaxy S II"],
		"SGH-I777": [p, "Galaxy S II"],
		"SGH-I896": [p, "Galaxy S Captivate"],
		"SGH-I897": [p, "Captivate"],
		"SGH-I927": [p, "Captivate Glide"],
		"SGH-I957": [p, "Galaxy Tab 8.9", "tablet"],
		"SGH-I957M": [p, "Galaxy Tab 8.9", "tablet"],
		"SGH-I957R": [p, "Galaxy Tab 8.9", "tablet"],
		"SGH-I987": [p, "Galaxy Tab 7.0", "tablet"],
		"SGH-I997": [p, "Galaxy S Infuse 4G"],
		"SGH-T499": [p, "Dart"],
		"SGH-T499V": [p, "Galaxy Mini"],
		"SGH-T499Y": [p, "Galaxy Mini"],
		"SGH-T589R": [p, "Galaxy Q"],
		"SGH-T839": [p, "T-Mobile Sidekick"],
		"SGH-T959": [p, "Galaxy S Vibrant"],
		"SGH-T959D": [p, "Galaxy S Fascinate 3G+"],
		"SGH-T959P": [p, "Galaxy S Fascinate 4G"],
		"SGH-T959V": [p, "Galaxy S 4G"],
		"SGH-T989": [p, "Galaxy S II"],
		"SGH-T989D": [p, "Galaxy S II X"],
		"SHV-E120L": [p, "Galaxy S II HD LTE"],
		"SHV-E120S": [p, "Galaxy S II HD LTE"],
		"SHV-E110S": [p, "Galaxy S II LTE"],
		"SHV-E160K": [p, "Galaxy Note"],
		"SHV-E160S": [p, "Galaxy Note LTE"],
		"SHW-M110S": [p, "Galaxy S"],
		"SHW-M130L": [p, "Galaxy U"],
		"SHW-M130K": [p, "Galaxy K"],
		"SHW-M180K": [p, "Galaxy Tab", "tablet"],
		"SHW-M180L": [p, "Galaxy Tab", "tablet"],
		"SHW-M180S": [p, "Galaxy Tab", "tablet"],
		"SHW-M190S": [p, "Galaxy S Hoppin"],
		"SHW-M250K": [p, "Galaxy S II"],
		"SHW-M250L": [p, "Galaxy S II"],
		"SHW-M250S": [p, "Galaxy S II"],
		"SHW-M380S": [p, "Galaxy Tab 10.1", "tablet"],
		"SMT-i9100": [p, "SMT-I9100", "tablet"],
		"SPH-D700": [p, "Epic 4G"],
		"SPH-D705": [p, "Epic 4G 2"],
		"SPH-D710": [p, "Epic 4G Touch"],
		"SPH-M580": [p, "Replenish"],
		"SPH-M910": [p, "Intercept"],
		"SPH-P100": [p, "Galaxy Tab", "tablet"],
		"YP-GB70": [p, "Galaxy Player"],
		"YP-GS1": [p, "Galaxy S WiFi 3.6"],
		"YP-G1": [p, "Galaxy S WiFi 4.0"],
		"YP-G70": [p, "Galaxy S WiFi 5.0"],
		I897: [p, "Captivate"],
		I7500: [p, "Galaxy"],
		I9000: [p, "Galaxy S"],
		T959: [p, "Galaxy S Vibrant"],
		"Galaxy Note": [p, "Galaxy Note"],
		"Galaxy S II": [p, "Galaxy S II"],
		"GALAXY Tab": [p, "Galaxy Tab", "tablet"],
		"SC-01C": [p, "Galaxy Tab", "tablet"],
		"SC-01D": [p, "Galaxy Tab 10.1 LTE", "tablet"],
		"SC-02B": [p, "Galaxy S"],
		"SC-02C": [p, "Galaxy S II"],
		"SC-03D": [p, "Galaxy S II LTE"],
		ISW11SC: [p, "Galaxy S II WiMAX"],
		"SH-03C": [i, "Lynx 3D"],
		"SH-12C": [i, "Aquos"],
		SBM006SH: [i, "Aquos"],
		SBM102SH: [i, "Aquos 102SH"],
		IS12SH: [i, "Aquos IS12SH"],
		IS01: [i, "IS01"],
		IS03: [i, "IS03"],
		"SH-01D": [i, "Aquos SH-01D"],
		"SH-13C": [i, "Aquos SH-13C"],
		SBM003SH: [i, "Galapagos"],
		SBM005SH: [i, "Galapagos"],
		SH8118U: [i, "SH8118U"],
		SH8128U: [i, "SH8128U"],
		SH8188U: [i, "SH8188U"],
		SH8268U: [i, "SH8268U"],
		"INFOBAR C01": [i, "INFOBAR C01"],
		"SPX-5": ["Simvalley", "SPX-5"],
		E10a: [c, "Xperia X10 Mini"],
		E10i: [c, "Xperia X10 Mini"],
		E10iv: [c, "Xperia X10 Mini"],
		E15a: [c, "Xperia X8"],
		E15i: [c, "Xperia X8"],
		E16i: [c, "W8 Walkman"],
		LT15a: [c, "Xperia Arc"],
		LT15i: [c, "Xperia Arc"],
		"LT15i-o": [c, "Xperia Arc"],
		LT18a: [c, "Xperia Arc S"],
		LT18i: [c, "Xperia Arc S"],
		LT18iv: [c, "Xperia Arc S"],
		"LT18i-o": [c, "Xperia Arc S"],
		LT26i: ["Sony", "Xperia S"],
		LT28i: ["Sony", "Xperia Ion"],
		MK16a: [c, "Xperia Pro"],
		MK16i: [c, "Xperia Pro"],
		MT11a: [c, "Xperia Neo V"],
		MT11i: [c, "Xperia Neo V"],
		MT11iv: [c, "Xperia Neo V"],
		"MT11i-o": [c, "Xperia Neo V"],
		MT15a: [c, "Xperia Neo"],
		MT15i: [c, "Xperia Neo"],
		MT15iv: [c, "Xperia Neo"],
		"MT15i-o": [c, "Xperia Neo"],
		R800a: [c, "Xperia Play"],
		R800i: [c, "Xperia Play"],
		R800at: [c, "Xperia Play"],
		R800x: [c, "Xperia Play"],
		SK17a: [c, "Xperia Mini Pro"],
		SK17i: [c, "Xperia Mini Pro"],
		SK17iv: [c, "Xperia Mini Pro"],
		"SK17i-o": [c, "Xperia Mini Pro"],
		ST15a: [c, "Xperia Mini"],
		ST15i: [c, "Xperia Mini"],
		ST17i: [c, "Xperia Active"],
		ST18a: [c, "Xperia Ray"],
		ST18i: [c, "Xperia Ray"],
		WT13i: [c, "Mix Walkman"],
		WT18i: [c, "Walkman"],
		WT19a: [c, "Live with Walkman"],
		WT19i: [c, "Live with Walkman"],
		U20a: [c, "Xperia X10 Mini Pro"],
		U20i: [c, "Xperia X10 Mini Pro"],
		U20iv: [c, "Xperia X10 Mini Pro"],
		X8: [c, "Xperia X8"],
		X10a: [c, "Xperia X10"],
		X10i: [c, "Xperia X10"],
		X10iv: [c, "Xperia X10"],
		...
		"SO-01B": [c, "Xperia X10"],
		"SO-01C": [c, "Xperia Arc"],
		"SO-01D": [c, "Xperia Play"],
		"SO-02C": [c, "Xperia Acro"],
		"SO-02D": [c, "Xperia NX"],
		"SO-03C": [c, "Xperia Ray"],
		"SO-03D": [c, "Xperia Acro HD"],
		"XPERIA X8": [c, "Xperia X8"],
		"Sony Tablet P": ["Sony", "Tablet P", "tablet"],
		"Sony Tablet S": ["Sony", "Tablet S", "tablet"],
		"NW-Z1000Series": ["Sony", "Walkman"],
		"TCL A990": ["TCL", "A990", "tablet"],
		...
		detect: function(y) {
			...
			if (y.match("iPhone;") || y.match("iPad;") || y.match("iPod;")) {
				...
				if (y.match("Windows Phone OS")) {
					this.os.name = "Windows Phone";
					this.os.version = new f({
						value: y.match(/Windows Phone OS ([0-9.]*)/)[1]
					});
			...
			if (y.match("RIM Tablet OS")) {
				...
				this.os.version = new f({
					value: y.match(/RIM Tablet OS ([0-9.]*)/)[1]
				});
				this.device.manufacturer = "RIM";
			...
			if (y.match("(?:web|hpw)OS")) {
				this.os.name = "webOS";
				this.os.version = new f({
					value: y.match(/(?:web|hpw)OS\/([0-9.]*)/)[1]
				});
				if (y.match("tablet")) {
					this.device.type = "tablet"
				} else {
